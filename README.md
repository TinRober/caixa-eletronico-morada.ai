...
9. Durante o desenvolvimento do cálculo de cédulas para o saque, surgiu uma dificuldade ao tentar sacar valores ímpares, a princípio eu nem tinha cogitado a possibilidade de sacar números ímpares. O algoritmo original impedia o uso da nota de 5 em situações onde ela era necessária, tornando impossível montar valores ímpares com as cédulas disponíveis. O problema ocorria porque todas as outras notas são pares, e qualquer valor ímpar só pode ser formado usando pelo menos uma nota de 5. A solução foi ajustar a lógica para, sempre que o valor solicitado for ímpar, retirar automaticamente uma nota de 5 antes de distribuir o restante. Assim, o valor remanescente sempre será par e pode ser montado normalmente com as outras cédulas. Após essa alteração, o saque passou a funcionar corretamente para qualquer valor válido, incluindo os ímpares.
